...
import net.pkk.kangaicodemother.ai.AiCodeGenTypeRoutingService;
import net.pkk.kangaicodemother.ai.AiCodeGenTypeRoutingServiceFactory;
...
import net.pkk.kangaicodemother.core.handler.StreamHandlerExecutor;
...
public class AppServiceImpl extends ServiceImpl<AppMapper, App> implements AppService {
    ...
    public String deployApp(Long appId, User loginUser) {
        ...
        try {
            ...
            throw new BusinessException(ErrorCode.SYSTEM_ERROR, "复制文件部署目录失败" + e.getMessage());
        }
        // 9. 更新数据库
