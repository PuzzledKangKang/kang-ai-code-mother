...
import net.pkk.kangaicodemother.manager.CosManager;
import net.pkk.kangaicodemother.service.ScreenshotService;
import net.pkk.kangaicodemother.utils.WebScreenshotUtils;
...
public class ScreenshotServiceImpl implements ScreenshotService {
    ...
    public String generateAndUpload(String webUrl) {
        // 参数校验
        ThrowUtils.throwIf(StrUtil.isBlank(webUrl), ErrorCode.PARAMS_ERROR,"截图的网页地址不能为空");
