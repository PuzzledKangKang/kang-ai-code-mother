...
import net.pkk.kangaicodemother.constant.UserConstant;
...
public class AppController {
    ...
    @Cacheable(
            value = "good_app_page",
            key = "T(net.pkk.kangaicodemother.utils.CacheKeyUtils).generateKey(#appQueryRequest)",
